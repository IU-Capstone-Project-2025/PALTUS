...
public class ExceptionLoggingAspect {
    ...
    @org.aspectj.lang.annotation.Around("execution(* com.paltus.backend..*(..))")
    public Object logAround(org.aspectj.lang.ProceedingJoinPoint joinPoint) throws Throwable {
        try {
            ...
            log.error("Location: {}.{} (line {})", element.getClassName(), element.getMethodName(), element.getLineNumber());
